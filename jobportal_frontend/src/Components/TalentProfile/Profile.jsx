  ...
  return (
    <div className='w-2/3 ' >
      ...
      <div className='relative '>
        ...
        <img className='rounded-full w-48 h-48 -bottom-1/4 absolute left-3  border-mine-shaft-950 border-8' src={profile.picture ? `data:image/jpeg;base64,${profile.picture}`:"./src/assets/avatar-9.png"} alt="" />
